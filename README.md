...
안녕하세요! ***"포기하지 않는 개발자"*** 안진혁입니다!  
과거 국비지원 학원 6개월 수료 후 
spring, jsp, jquery, mybatis, mariaDB를 활용하여 게시판을 만들고 아마존 ec2에 배포까지 완료했던 경험이 있습니다.
오랜시간이 흘렀지만 다시 기억을 떠올리면서 
aop, intercepter, controlleradvice 등의 개념을 통해 더욱 확장성 있고 안정적인 게시판을 만들어 보았습니다.

<br />

# 📝Projects
2주간 진행했던 프로젝트 입니다.
처음에는 기억이 잘 나지 않아 기존에 작성했던 코드를 분석하느라 시간이 많이 소모되었지만
1주일 정도가 지난 후 전체적인 구조가 익숙해져 속도를 붙이게 되었습니다.
...
- 모드 메서드에 시작/종료 로그를 찍는 것은 코드 중복과 가독성 저하가 있었습니다.
### 해결방안(AOP도입)
